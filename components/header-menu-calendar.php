            ...
            <ul class="navbar-nav justify-content-center w-100">
              ...
              <li class="nav-item">
                <?php if (isset($_SESSION['ID'])) { ?>
                  <div class="dropdown d-inline" style="top: 36px;">
                    <a class="nav-link dropdown-toggle d-inline" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      <?= $_SESSION['NOME'] . " " . $_SESSION['SOBRENOME']; ?>
                    </a>

                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                      <a class="dropdown-item" href="../pages/sobre.php">Perfil</a>
                      <a class="dropdown-item" href="../pages/post_noticias.php">Postar Noticia</a>
