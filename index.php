  ...
  <section class="blog-post-area section-gap relative">
    <div class="container">
      <div class="row">
            ...
            <div class="col-lg-6 col-md-6">
              <div class="single-amenities">
                <div class="amenities-thumb">
                  <img class="img-fluid w-100" src="http://portal.ifpe.edu.br/noticias/ifb-lanca-chamada-sobre-relato-de-experiencias-exitosas-da-rede/relatos.jpg/@@images/3fd29690-b1f2-4921-9377-b90d9a3582ea.jpeg" alt="" />
                </div>
        ...
        <?php include 'components/post-sidebar.php' ?>
